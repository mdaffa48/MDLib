...
public final class SpigotUpdateChecker {
    ...
    private SpigotUpdateChecker(@NotNull JavaPlugin plugin, int pluginID, @NotNull VersionScheme versionScheme) {
        this.plugin = plugin;
     ...
     */
    @NotNull
    public static SpigotUpdateChecker init(@NotNull JavaPlugin plugin, int pluginID, @NotNull VersionScheme versionScheme) {
     ...
     */
    @NotNull
    public static SpigotUpdateChecker init(@NotNull JavaPlugin plugin, int pluginID) {
     ...
     * {@link SpigotUpdateChecker#requestUpdateCheck()}.
     */
