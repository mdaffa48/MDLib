...
public class SimpleInventoryScheme {
     ...
     */
    public SimpleInventoryScheme mask(String mask) {
    ...
    /**
     * Add multiple masks to this scheme including all sort of characters.
     * For example, "111111111", "110101011", "111111111"
     *
     * @param masks multiple 9-character masks
     * @return this scheme instance
     */
    public SimpleInventoryScheme masks(String... masks) {
     ...
     * @return this scheme instance
     */
    public SimpleInventoryScheme bindItem(char character, ItemStack item, Consumer<InventoryClickEvent> handler) {
     ...
     * @return this scheme instance
     */
    public SimpleInventoryScheme bindItem(char character, ItemStack item) {
     ...
     * @return this scheme instance
     */
    public SimpleInventoryScheme unbindItem(char character) {
     ...
     */
    public void apply(SimpleInventory inv) {
